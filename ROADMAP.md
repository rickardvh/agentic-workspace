...
- The current promoted tranche is stable package contract freeze so the installed planning and memory surfaces that have now survived several hardening passes can stop changing shape casually.
