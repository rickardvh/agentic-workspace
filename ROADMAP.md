...
- The current promoted tranche is first-party module contract so the workspace layer can stop relying on implicit planning-versus-memory branching and instead orchestrate both packages through a clearer shared internal module boundary.
