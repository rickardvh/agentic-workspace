...
3. Next promotions should come from the remaining startup-filename portability lane unless new mixed-agent friction produces a clearer bounded candidate first.
