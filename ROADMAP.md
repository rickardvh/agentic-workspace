...
3. Treat issue `#66` and issue `#65` as the highest-priority pair because they affect whether the canonical upgrade path remains trustworthy on preserved custom repos.
