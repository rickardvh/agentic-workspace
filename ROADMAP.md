...
2. After the first bounded dogfood pass and the first ordinary-use synergy proof, prioritize stronger mixed-agent and cross-agent continuity evidence before widening into broader bootstrap hardening.
