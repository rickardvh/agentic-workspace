...
3. Treat issue `#69` and issue `#72` as the highest-priority pair because they decide whether jumpstart is a real quiet workflow or just a partially productized concept.
4. Treat issue `#67` next if preserved execplans still need clearer upgrade guidance after the remaining jumpstart work.
