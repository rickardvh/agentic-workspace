    ...
    "interface": {
      ...
      "options": [
        ...
        },
        {
          ...
          "help": "Select one exact decision-point carry work-binding key for closeout.",
          "name": "decision_point_carry_key"
        },
        {
          "flags": [
            "--prune-decision-point-carry-key"
          ],
          "help": "Mark one exact abandoned decision-point carry stale while preserving other active carries.",
          "name": "prune_decision_point_carry_key"
        },
        {
          "action": "store_true",
          "flags": [
    ...
    "interface": {
      ...
      "options": [
        ...
        },
        {
          ...
          "help": "Optimistic owner revision; stop if the execplan changed before closeout.",
        ...
        },
        {
          ...
          "help": "Optimistic parent lane revision; stop if its current-slice relation changed.",
          "name": "expect_lane_revision"
        },
        {
          "default": "",
          "flags": [
            "--expect-integration-revision"
          ],
          "help": "Optimistic integration subject revision; stop if proposals or receipts changed.",
          "name": "expect_integration_revision"
        },
        {
          "action": "store_true",
          "flags": [
