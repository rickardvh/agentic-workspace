...
Operation: planning.integration-apply.lifecycle
...
def run(args: argparse.Namespace) -> int:
    return run_operation_ir(generated_operation_contract('planning.integration-apply.lifecycle'), args)


def invoke(values: Mapping[str, Any]) -> object:
    return run_operation_callable(generated_operation_contract('planning.integration-apply.lifecycle'), values)
