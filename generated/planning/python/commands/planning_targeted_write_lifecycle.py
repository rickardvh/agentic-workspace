...
Operation: planning.targeted-write.lifecycle
...
def run(args: argparse.Namespace) -> int:
    return run_operation_ir(generated_operation_contract('planning.targeted-write.lifecycle'), args)


def invoke(values: Mapping[str, Any]) -> object:
    return run_operation_callable(generated_operation_contract('planning.targeted-write.lifecycle'), values)
