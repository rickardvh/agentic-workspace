    ...
    values = run_operation_values(
        ...
        initial_values={
            "operation_id": operation.get("id"),
                ...
                'apply_lane_current_slice_reconcile': getattr(args, 'apply_lane_current_slice_reconcile', False),
                'owner_surface': getattr(args, 'owner_surface', ''),
                'relation_identity': getattr(args, 'relation_identity', ''),
                'subject': getattr(args, 'subject', ''),
                'expected_lane_revision': getattr(args, 'expected_lane_revision', ''),
                'transition': getattr(args, 'transition', ''),
                'expected_execplan': getattr(args, 'expected_execplan', ''),
                'apply_issue_relation_reconcile': getattr(args, 'apply_issue_relation_reconcile', False),
                'apply_issue_relation_migration': getattr(args, 'apply_issue_relation_migration', False),
                'apply_pending_integrations': getattr(args, 'apply_pending_integrations', False),
                ...
                'record_feature_completion': getattr(args, 'record_feature_completion', False),
                ...
                'compact_retained': getattr(args, 'compact_retained', False),
    ...
    with contextlib.redirect_stdout(io.StringIO()):
        result = run_operation_values(
            ...
            initial_values={
                ...
                'apply_lane_current_slice_reconcile': values.get('apply_lane_current_slice_reconcile', False),
                'owner_surface': values.get('owner_surface', ''),
                'relation_identity': values.get('relation_identity', ''),
                'subject': values.get('subject', ''),
                'expected_lane_revision': values.get('expected_lane_revision', ''),
                'transition': values.get('transition', ''),
                'expected_execplan': values.get('expected_execplan', ''),
                'apply_issue_relation_reconcile': values.get('apply_issue_relation_reconcile', False),
                'apply_issue_relation_migration': values.get('apply_issue_relation_migration', False),
                'apply_pending_integrations': values.get('apply_pending_integrations', False),
                'preview': values.get('preview', False),
                ...
                'record_feature_completion': values.get('record_feature_completion', False),
                ...
                'compact_retained': values.get('compact_retained', False),
                'export_dir': values.get('export_dir', None),
