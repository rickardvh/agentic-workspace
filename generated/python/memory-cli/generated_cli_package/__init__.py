...
def build_generated_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(prog="agentic-memory", description="", epilog=epilog, formatter_class=argparse.RawDescriptionHelpFormatter)
...
def _run_runtime_handler(operation_id: str, args: argparse.Namespace) -> int:
    from agentic_command_generation.memory_runtime_cli import _GENERATED_RUNTIME_HANDLERS
...
def main(argv: list[str] | None = None) -> int:
    import sys
    from agentic_command_generation.memory_runtime_cli import main as runtime_main
