...
def _run_runtime_handler(operation_id: str, args: argparse.Namespace) -> int:
    from agentic_command_generation.workspace_runtime_cli import _GENERATED_RUNTIME_HANDLERS
...
def main(argv: list[str] | None = None) -> int:
    import sys
    from agentic_command_generation.workspace_runtime_cli import main as runtime_main
