...
const runtimeCommand = process.env.AGENTIC_WORKSPACE_RUNTIME ?? "python -c \"import sys; from agentic_command_generation.workspace_generated_cli_package import main; raise SystemExit(main(sys.argv[1:]))\"";
