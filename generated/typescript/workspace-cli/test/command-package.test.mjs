...
test('generated package metadata exposes expected commands', () => {
  const expected = ["config", "defaults", "doctor", "implement", "init", "install", "memory", "modules", "ownership", "planning", "preflight", "proof", "reconcile", "report", "setup", "skills", "start", "status", "summary", "uninstall", "upgrade"];
