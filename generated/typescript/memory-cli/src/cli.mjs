...
const supportedCommands = new Set(["capture-note", "doctor", "list-files", "list-skills", "promotion-report", "report", "route", "route-report", "search", "status", "sync-memory", "verify-payload"]);
