...
test('generated package metadata exposes expected commands', () => {
  const expected = ["capture-note", "doctor", "list-files", "list-skills", "promotion-report", "report", "route", "route-report", "route-review", "search", "status", "sync-memory", "verify-payload"];
