...
def run(args: argparse.Namespace) -> int:
    return run_operation_ir(generated_operation_contract('instructions.list'), args)


def invoke(values: Mapping[str, Any]) -> object:
    return run_operation_callable(generated_operation_contract('instructions.list'), values)
