...
Operation: correction-event.query
...
def run(args: argparse.Namespace) -> int:
    return run_operation_ir(generated_operation_contract('correction-event.query'), args)


def invoke(values: Mapping[str, Any]) -> object:
    return run_operation_callable(generated_operation_contract('correction-event.query'), values)
