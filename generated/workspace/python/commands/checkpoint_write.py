...
def run(args: argparse.Namespace) -> int:
    from ..primitives.workspace_runtime import _run_checkpoint_write_adapter

    return _run_checkpoint_write_adapter(args)


def invoke(_values: Mapping[str, Any]) -> object:
    raise RuntimeError('checkpoint.write' + ' has no generated operation callable')
