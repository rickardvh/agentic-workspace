...
def run(args: argparse.Namespace) -> int:
    ...
    if not command_value:
        ...
        return 0
    local_handlers = {'decision-scaffold': ('agentic_workspace.workspace_runtime_primitives', '_run_planning_decision_adapter'), 'decision-promote': ('agentic_workspace.workspace_runtime_primitives', '_run_planning_decision_adapter'), 'closeout': ('agentic_workspace.workspace_runtime_primitives', '_run_planning_closeout_adapter'), 'handoff': ('agentic_workspace.workspace_runtime_primitives', '_run_planning_handoff_adapter'), 'reconcile': ('agentic_workspace.workspace_runtime_planning', '_run_reconcile_report_adapter')}
    ...
    for commands, attr in [(['promote-to-plan'], 'item_id'), (['lane-promote', 'lane-activate', 'lane-close', 'lane-archive'], 'lane'), (['archive-plan', 'closeout'], 'plan'), (['close-item'], 'item'), (['create-review'], 'slug'), (['targeted-write'], 'targeted_write_plan')]:
        if str(command_value) in commands:
            value = getattr(args, attr, None)
            if value is not None and value != '' and value != []:
                argv.append(str(value))
    for option, attr, fallback_attr, kind in [('--lane', 'owner_lane', '', 'value'), ('--id', 'id', '', 'value'), ('--title', 'title', '', 'value'), ('--source', 'source', '', 'value'), ('--artifact', 'artifact', '', 'value'), ('--outcome', 'outcome', '', 'value'), ('--promotion-rule', 'promotion_rule', '', 'value'), ('--parent-decomposition', 'parent_decomposition', '', 'value'), ('--purpose', 'purpose', '', 'value'), ('--proof-strategy', 'proof_strategy', '', 'value'), ('--bind-execplan', 'bind_execplan', '', 'value'), ('--source-ref', 'source_ref', '', 'value'), ('--target', 'target', '', 'value'), ('--audit-cursor', 'audit_cursor', '', 'value'), ('--audit-page-size', 'audit_page_size', '', 'value'), ('--alternate-lane-id', 'alternate_lane_id', '', 'value'), ('--plan-slug', 'plan_slug', '', 'value'), ('--scope', 'scope', '', 'value'), ('--classification', 'classification', '', 'value'), ('--route', 'route', '', 'value'), ('--current-slice', 'current_slice', '', 'value'), ('--proof', 'proof', '', 'value'), ('--residual-work', 'residual_work', '', 'value'), ('--parent-contribution', 'parent_contribution', '', 'value'), ('--parent-close-permission', 'parent_close_permission', '', 'value'), ('--next-owner', 'next_owner', '', 'value'), ('--skipped-reason', 'skipped_reason', '', 'value'), ('--expected-savings', 'expected_savings', '', 'value'), ('--actual-friction', 'actual_friction', '', 'value'), ('--proof-result', 'proof_result', '', 'value'), ('--quality-concern', 'quality_concern', '', 'value'), ('--decomposition-adjustment', 'decomposition_adjustment', '', 'value'), ('--reason', 'reason', '', 'value'), ('--owner', 'owner', '', 'value'), ('--owner-ref', 'owner_ref', '', 'value'), ('--patch', 'patch', '', 'value'), ('--completion-correction', 'completion_correction', '', 'value'), ('--mode', 'mode', '', 'value'), ('--current-work-id', 'current_work_id', '', 'value'), ('--expect-current-work-revision', 'expect_current_work_revision', '', 'value'), ('--issue', 'issue', '', 'value'), ('--proposal-id', 'proposal_id', '', 'value'), ('--proposal', 'proposal', '', 'value'), ('--external-ref', 'external_ref', '', 'value'), ('--lane', 'issue_lane', '', 'value'), ('--priority', 'priority', '', 'value'), ('--depends-on', 'depends_on', '', 'value'), ('--rationale', 'rationale', '', 'value'), ('--maturity', 'maturity', '', 'value'), ('--expect-relation-revision', 'expect_relation_revision', '', 'value'), ('--requested-transition', 'requested_transition', '', 'value'), ('--parent-boundary', 'parent_boundary', '', 'value'), ('--invariant', 'invariant', '', 'value'), ('--expect-subject-revision', 'expect_subject_revision', '', 'value'), ('--expect-target-revision', 'expect_target_revision', '', 'value'), ('--expect-proposal-revision', 'expect_proposal_revision', '', 'value'), ('--parent-lane-closeout', 'parent_lane_closeout', '', 'value'), ('--closure-decision', 'closure_decision', '', 'value'), ('--intent-satisfied', 'intent_satisfied', '', 'value'), ('--unsolved-intent', 'unsolved_intent', '', 'value'), ('--intent-evidence', 'intent_evidence', '', 'value'), ('--closure-reason', 'closure_reason', '', 'value'), ('--closure-evidence', 'closure_evidence', '', 'value'), ('--reopen-trigger', 'reopen_trigger', '', 'value'), ('--discard-summary', 'discard_summary', '', 'value'), ('--continuation-summary', 'continuation_summary', '', 'value'), ('--claim-level', 'claim_level', '', 'value'), ('--intent-status', 'intent_status', '', 'value'), ('--residue', 'residue', '', 'value'), ('--proof-from', 'proof_from', '', 'value'), ('--residue-owner', 'residue_owner', '', 'value'), ('--what-happened', 'what_happened', '', 'value'), ('--scope-touched', 'scope_touched', '', 'value'), ('--changed-surfaces', 'changed_surfaces', '', 'value'), ('--review-summary', 'review_summary', '', 'value'), ('--outcome-summary', 'outcome_summary', '', 'value'), ('--expect-planning-revision', 'expect_planning_revision', '', 'value'), ('--expect-owner-revision', 'expect_owner_revision', '', 'value'), ('--expect-lane-revision', 'expect_lane_revision', '', 'value'), ('--activate', 'activate', '', 'flag'), ('--queue', 'queue', '', 'flag'), ('--switch-active', 'switch_active', '', 'flag'), ('--prep-only', 'prep_only', '', 'flag'), ('--overwrite', 'overwrite', '', 'flag'), ('--remove-source', 'remove_source', '', 'flag'), ('--refresh-existing', 'refresh_existing', '', 'flag'), ('--record-feature-completion', 'record_feature_completion', '', 'flag'), ('--dry-run', 'dry_run', '', 'flag'), ('--apply', 'apply', '', 'flag'), ('--render-markdown', 'render_markdown', '', 'flag'), ('--apply-cleanup', 'apply_cleanup', '', 'flag'), ('--prepare-closeout', 'prepare_closeout', '', 'flag'), ('--retain-archive', 'retain_archive', '', 'flag'), ('--compact-retained', 'compact_retained', '', 'flag'), ('--export-dir', 'export_dir', '', 'value'), ('--discard-archive', 'discard_archive', '', 'flag'), ('--verbose', 'verbose', '', 'flag'), ('--path', 'paths', 'path', 'repeated'), ('--format', 'format', '', 'value')]:
        value = getattr(args, attr, None)
