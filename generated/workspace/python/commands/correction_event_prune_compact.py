...
Operation: correction-event.prune-compact
...
def run(args: argparse.Namespace) -> int:
    return run_operation_ir(generated_operation_contract('correction-event.prune-compact'), args)


def invoke(values: Mapping[str, Any]) -> object:
    return run_operation_callable(generated_operation_contract('correction-event.prune-compact'), values)
