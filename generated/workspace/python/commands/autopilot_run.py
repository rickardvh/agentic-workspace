...
def run(args: argparse.Namespace) -> int:
    from ..primitives.workspace_runtime import _run_autopilot_adapter

    return _run_autopilot_adapter(args)


def invoke(_values: Mapping[str, Any]) -> object:
    raise RuntimeError('autopilot.run' + ' has no generated operation callable')
