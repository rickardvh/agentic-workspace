    ...
    values = run_operation_values(
        ...
        initial_values={
            "operation_id": operation.get("id"),
                ...
                'assignment_command': getattr(args, 'assignment_command', None),
                'assignment_id': getattr(args, 'assignment_id', None),
                'assignment_revision': getattr(args, 'assignment_revision', None),
                'run_id': getattr(args, 'run_id', None),
                'assignment_gate_json': getattr(args, 'assignment_gate_json', None),
                'assignment_policy_json': getattr(args, 'assignment_policy_json', None),
                'delegation_decision_json': getattr(args, 'delegation_decision_json', None),
                'aw_proof_receipt_json': getattr(args, 'aw_proof_receipt_json', None),
                'run_state_json': getattr(args, 'run_state_json', None),
                'target_name': getattr(args, 'target_name', None),
                'transport': getattr(args, 'transport', 'manual'),
                'packet_json': getattr(args, 'packet_json', None),
                'return_json': getattr(args, 'return_json', None),
                'return_id': getattr(args, 'return_id', None),
                'artifact_ref': getattr(args, 'artifact_ref', None),
                'current_authority_ref': getattr(args, 'current_authority_ref', None),
                'live_mutation_baseline': getattr(args, 'live_mutation_baseline', None),
                'admission_status': getattr(args, 'admission_status', None),
                'reason': getattr(args, 'reason', None),
                'scope': getattr(args, 'scope', None),
                'expires_at': getattr(args, 'expires_at', None),
                'dry_run': getattr(args, 'dry_run', False),
                'instructions_command': getattr(args, 'instructions_command', None),
                'name': getattr(args, 'name', None),
                'paths': getattr(args, 'paths', []),
                'task': getattr(args, 'task', ''),
                'changed': getattr(args, 'changed', []),
                'agent_guidance_command': getattr(args, 'agent_guidance_command', None),
                'guidance_id': getattr(args, 'guidance_id', None),
                'expected_revision': getattr(args, 'expected_revision', None),
                'expected_record_revisions_json': getattr(args, 'expected_record_revisions_json', None),
                'instruction': getattr(args, 'instruction', None),
                'replacement_guidance_id': getattr(args, 'replacement_guidance_id', None),
                'merge_guidance_ids': getattr(args, 'merge_guidance_ids', []),
                'split_instructions': getattr(args, 'split_instructions', []),
                'explicit_remember': getattr(args, 'explicit_remember', False),
                'event_json': getattr(args, 'event_json', None),
                'trusted_host_event_json': getattr(args, 'trusted_host_event_json', None),
                'host_event_ref': getattr(args, 'host_event_ref', None),
                'trusted_authority_receipt_ref': getattr(args, 'trusted_authority_receipt_ref', None),
                'delivery_id': getattr(args, 'delivery_id', None),
                'event_id': getattr(args, 'event_id', None),
                'target_identity_ref': getattr(args, 'target_identity_ref', None),
                'target_revision': getattr(args, 'target_revision', None),
                'source': getattr(args, 'source', None),
                'producer_id': getattr(args, 'producer_id', None),
                'desired_behavior': getattr(args, 'desired_behavior', None),
                'replaced_behavior': getattr(args, 'replaced_behavior', None),
                'invariant_id': getattr(args, 'invariant_id', None),
                'behavior_class': getattr(args, 'behavior_class', None),
                'route_decisions': getattr(args, 'route_decisions', []),
                'evidence_hash': getattr(args, 'evidence_hash', None),
    ...
    with contextlib.redirect_stdout(io.StringIO()):
        result = run_operation_values(
            ...
            initial_values={
                ...
                'phase': values.get('phase', None),
                'subsystem': values.get('subsystem', None),
                'surface': values.get('surface', None),
                ...
                'assignment_command': values.get('assignment_command', None),
                'assignment_id': values.get('assignment_id', None),
                'assignment_revision': values.get('assignment_revision', None),
                'run_id': values.get('run_id', None),
                'assignment_gate_json': values.get('assignment_gate_json', None),
                'assignment_policy_json': values.get('assignment_policy_json', None),
                'delegation_decision_json': values.get('delegation_decision_json', None),
                'aw_proof_receipt_json': values.get('aw_proof_receipt_json', None),
                'run_state_json': values.get('run_state_json', None),
                'target_name': values.get('target_name', None),
                'transport': values.get('transport', 'manual'),
                'packet_json': values.get('packet_json', None),
                'return_json': values.get('return_json', None),
                'return_id': values.get('return_id', None),
                'artifact_ref': values.get('artifact_ref', None),
                'current_authority_ref': values.get('current_authority_ref', None),
                'live_mutation_baseline': values.get('live_mutation_baseline', None),
                'admission_status': values.get('admission_status', None),
                'reason': values.get('reason', None),
                'scope': values.get('scope', None),
                'expires_at': values.get('expires_at', None),
                'dry_run': values.get('dry_run', False),
                'instructions_command': values.get('instructions_command', None),
                'name': values.get('name', None),
                'paths': values.get('paths', []),
                'task': values.get('task', ''),
                'changed': values.get('changed', []),
                'agent_guidance_command': values.get('agent_guidance_command', None),
                'guidance_id': values.get('guidance_id', None),
                'expected_revision': values.get('expected_revision', None),
                'expected_record_revisions_json': values.get('expected_record_revisions_json', None),
                'instruction': values.get('instruction', None),
                'replacement_guidance_id': values.get('replacement_guidance_id', None),
                'merge_guidance_ids': values.get('merge_guidance_ids', []),
                'split_instructions': values.get('split_instructions', []),
                'explicit_remember': values.get('explicit_remember', False),
                'event_json': values.get('event_json', None),
                'trusted_host_event_json': values.get('trusted_host_event_json', None),
                'host_event_ref': values.get('host_event_ref', None),
                'trusted_authority_receipt_ref': values.get('trusted_authority_receipt_ref', None),
                'delivery_id': values.get('delivery_id', None),
                'event_id': values.get('event_id', None),
                'target_identity_ref': values.get('target_identity_ref', None),
                'target_revision': values.get('target_revision', None),
                'source': values.get('source', None),
                'producer_id': values.get('producer_id', None),
                'desired_behavior': values.get('desired_behavior', None),
                'replaced_behavior': values.get('replaced_behavior', None),
                'invariant_id': values.get('invariant_id', None),
                'behavior_class': values.get('behavior_class', None),
                'route_decisions': values.get('route_decisions', []),
                'evidence_hash': values.get('evidence_hash', None),
