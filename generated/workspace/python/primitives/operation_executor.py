    ...
    values = run_operation_values(
        ...
        initial_values={
            "operation_id": operation.get("id"),
                ...
                'subjects_json': getattr(args, 'subjects_json', None),
                'trusted_authority_receipt_json': getattr(args, 'trusted_authority_receipt_json', None),
    ...
    with contextlib.redirect_stdout(io.StringIO()):
        result = run_operation_values(
            ...
            initial_values={
                ...
                'subjects_json': values.get('subjects_json', None),
                'trusted_authority_receipt_json': values.get('trusted_authority_receipt_json', None),
