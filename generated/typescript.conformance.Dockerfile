...
RUN apt-get update \
    ...
    && python3 -m pip install --break-system-packages --no-cache-dir jsonschema "command-generation @ git+https://github.com/rickardvh/command-generation.git@70392e88b1f4ce627c9e4d844869d1a1ea623723"
