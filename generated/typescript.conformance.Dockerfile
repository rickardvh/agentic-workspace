...
RUN apt-get update \
    ...
    && python3 -m pip install --break-system-packages --no-cache-dir jsonschema "command-generation @ git+https://github.com/rickardvh/command-generation.git@7bd918989b9698b8f3f7a477be65dd820fb0405e"
