...
def test_defaults_command_reports_machine_readable_default_routes_as_json(capsys) -> None:
    ...
    assert payload["prompt_routing"]["route_by_class"][0]["owner_surface"] == "src/agentic_workspace/_runtime_cli.py"
...
def test_defaults_section_selector_returns_prompt_routing_answer(capsys) -> None:
    ...
    assert payload["answer"]["route_by_class"][0]["owner_surface"] == "src/agentic_workspace/_runtime_cli.py"
