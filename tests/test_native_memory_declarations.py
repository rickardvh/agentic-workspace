...
'''
    ...
    workspace_registry = tmp_path / ".agentic-workspace/skills/REGISTRY.json"
    workspace_registry.parent.mkdir(parents=True)
    workspace_registry.write_bytes((ROOT / ".agentic-workspace/skills/REGISTRY.json").read_bytes())
