...
- Inputs inspected first: `docs/contributor-playbook.md`, `docs/lazy-discovery-measurements.md`, `.agentic-workspace/memory/repo/runbooks/dogfooding-feedback-routing.md`, `.agentic-workspace/memory/repo/runbooks/dogfooding-usage-ledger.md`
...
- Suggested action: Move the capture convention into `.agentic-workspace/memory/repo/runbooks/`, delete the docs copy, and keep `docs/` focused on broader contracts and review artifacts.
- Confidence: high
- Source: mixed
