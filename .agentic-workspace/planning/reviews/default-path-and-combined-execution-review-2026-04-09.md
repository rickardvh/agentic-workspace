...
- Inputs inspected first: `README.md`, `docs/default-path-contract.md`, `.agentic-workspace/docs/capability-aware-execution.md`, `docs/integration-contract.md`, `docs/contributor-playbook.md`, `TODO.md`
...
- Evidence: `README.md` now presents one default lifecycle path through `agentic-workspace`; `docs/default-path-contract.md` gives one default answer for install, startup, skill discovery, validation, and combined use; `.agentic-workspace/docs/capability-aware-execution.md` defines cheap direct execution, medium-reasoning direct work, stronger-planning-first, delegation-friendly, and stop-and-escalate categories while explicitly preferring quiet shaping over user interruption.
