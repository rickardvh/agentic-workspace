...
- `.agentic-workspace/memory/repo/` note set involved in current overlap findings
...
- Evidence sources: current doctor output, current memory notes under `.agentic-workspace/memory/repo/`, and the overlap-audit implementation in `packages/memory/src/repo_memory_bootstrap/_installer_memory.py`
