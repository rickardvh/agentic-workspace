...
- `.agentic-workspace/planning/execplans/review-driven-future-work-discovery.md`
- `packages/planning/`
- `packages/memory/`
...
Use scoped review artifacts, likely under `.agentic-workspace/planning/reviews/`, to capture:
...
- 2026-04-07: Promoted the review lane into shipped planning docs, bundled skills, and packaged `.agentic-workspace/planning/reviews/` contract surfaces.
