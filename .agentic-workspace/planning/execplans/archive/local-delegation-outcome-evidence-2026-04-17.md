...
- Rewrite `.agentic-workspace/config.local.toml` automatically in this first slice.
...
- TODO.md
- ROADMAP.md
- .agentic-workspace/planning/execplans/local-delegation-outcome-evidence-2026-04-17.md
- .agentic-workspace/planning/execplans/archive/local-delegation-outcome-evidence-2026-04-17.md
- .agentic-workspace/planning/reviews/local-delegation-outcome-evidence-dogfood-2026-04-17.md
...
- .agentic-workspace/docs/contract-schema-index.md
