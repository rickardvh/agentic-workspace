...
- Clarify `.agentic-workspace/memory/repo/mistakes/recurring-failures.md` as anti-trap and anti-rediscovery memory rather than bug tracking, and tighten the high-level memory-package framing so skimming readers are pushed toward one-home ownership and subordination to planning earlier.
