...
- `TODO.md`
- `ROADMAP.md`
- `.agentic-workspace/planning/execplans/lazy-discovery-contract-profile-and-selectors-2026-04-14.md`
...
- Outcome delivered: shipped `.agentic-workspace/docs/compact-contract-profile.md` plus the first compact answer envelope and narrow selectors on `agentic-workspace defaults`, `proof`, and `ownership`; aligned the front-door, proof, and ownership docs; and dogfooded the new retrieval path in this repo with bounded live queries.
