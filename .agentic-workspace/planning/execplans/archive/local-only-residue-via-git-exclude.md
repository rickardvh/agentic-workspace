...
- Continuation surface: .agentic-workspace/planning/execplans/local-only-residue-via-git-exclude.md
- Parent lane: ownership-boundary-and-local-only-mode

## Required Continuation

- Required follow-on for the larger intended outcome: yes
- Owner surface: .agentic-workspace/planning/execplans/local-only-residue-via-git-exclude.md
...
- TODO.md
- ROADMAP.md
- .agentic-workspace/planning/execplans/local-only-residue-via-git-exclude.md
