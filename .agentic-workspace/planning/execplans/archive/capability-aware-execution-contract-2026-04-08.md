...
- 2026-04-08: Completed by shipping `.agentic-workspace/docs/capability-aware-execution.md` in the planning payload, wiring the planning README, shipped AGENTS, manifest-generated quickstart/routing, and maintainer playbook back to that contract, and refreshing the root install from the updated package payload.
