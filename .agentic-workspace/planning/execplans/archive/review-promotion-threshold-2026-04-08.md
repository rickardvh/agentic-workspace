...
- 2026-04-08: Added the explicit threshold to `.agentic-workspace/planning/reviews/README.md`, aligned the review template and roadmap wording with the same rule, and removed the now-resolved candidate from `ROADMAP.md`.
