...
- TODO.md
- ROADMAP.md
- .agentic-workspace/planning/execplans/memory-routing-capture-cheap-path-2026-04-17.md
...
- Dogfooding result: this repo now carries two passing live routing fixtures, zero live Memory missed-note cases, and a compact package-context sync summary that points directly at `.agentic-workspace/memory/repo/domains/memory-package-context.md`.
