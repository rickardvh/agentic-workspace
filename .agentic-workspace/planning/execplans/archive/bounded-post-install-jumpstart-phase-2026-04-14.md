...
- `TODO.md`
- `ROADMAP.md`
- `.agentic-workspace/planning/execplans/bounded-post-install-jumpstart-phase-2026-04-14.md`
...
- Memory seed targets: `docs/delegated-judgment-contract.md`, `docs/resumable-execution-contract.md`, `.agentic-workspace/docs/capability-aware-execution.md`, `docs/execution-summary-contract.md`
