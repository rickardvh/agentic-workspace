...
- Make planning own account-specific or machine-specific preferences that already belong in `.agentic-workspace/config.local.toml`.
...
- TODO.md
- .agentic-workspace/planning/execplans/planner-worker-orchestrator-workflow-2026-04-17.md
- docs/
...
- Local capability and cost posture stays in `.agentic-workspace/config.local.toml`, not checked-in repo config.
...
- Follow-on routed to: `.agentic-workspace/planning/reviews/orchestrator-workflow-dogfood-2026-04-17.md`, GitHub issue `#172`, and `ROADMAP.md`.
