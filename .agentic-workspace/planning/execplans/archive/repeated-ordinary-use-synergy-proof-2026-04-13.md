...
- `TODO.md`
- `ROADMAP.md`
- `.agentic-workspace/planning/execplans/archive/repeated-ordinary-use-synergy-proof-2026-04-13.md`
...
- Freshness-gap question: before this slice, the shipped freshness lane missed explicit planning-state residue in `.agentic-workspace/memory/repo/current/project-state.md`; after this slice, both the bundled freshness script and `agentic-memory-bootstrap current check` flag that class of drift.
...
- The missing-synergy signal mapped cleanly to a shipped fix: explicit planning-state residue in `.agentic-workspace/memory/repo/current/*` is now treated as drift.
