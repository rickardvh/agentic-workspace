...
- **Contract Source**: Derive the handoff from `agentic-workspace planning handoff --format json`.
...
- `agentic-workspace planning handoff --format json`: Derived worker contract.
