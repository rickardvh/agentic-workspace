...
Use this directory for repeatable maintainer procedures that are not owned by Planning, Memory, Verification, or another shipped package domain. A repo-local skill may guide judgement or mechanics, but it does not acquire the authority of the domain it touches.
