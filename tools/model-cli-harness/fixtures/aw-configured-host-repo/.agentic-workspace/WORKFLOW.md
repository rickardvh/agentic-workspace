...
2. Run `agentic-workspace config --target . --profile compact --format json` when repo operating settings, local runtime posture, reporting style, workflow obligations, delegation, or closeout trust can affect the task.
