...
This generated adapter's configured invocation is `uv run agentic-workspace`. Use it directly for ordinary route commands; do not open raw config files to rediscover it.
