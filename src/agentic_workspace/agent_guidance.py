...
TRUSTED_AUTHORITY_HOST_ADMISSION_KEY_ID = "agentic-workspace-guidance-host-test-v1"
_TRUSTED_AUTHORITY_HOST_ADMISSION_KEYS: dict[str, dict[str, Any]] = {
...
def _host_admits_trusted_authority_event(*, ref: str, event: dict[str, Any], target_root: Path) -> bool:
    ...
    key = _TRUSTED_AUTHORITY_HOST_ADMISSION_KEYS.get(key_id)
