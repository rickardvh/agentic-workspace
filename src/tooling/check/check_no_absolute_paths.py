...
ALLOWED_FILE_LITERAL_EXCEPTIONS: dict[Path, frozenset[str]] = {
    Path("src/tooling/model-cli-harness/consumer_agent.py"): frozenset(
        ...
        for path in (
            ...
            "home/consumer/tmp",
            "home/consumer/.codex",
            "home/consumer/.codex/auth.json",
            "home/consumer/final.json",
            "home/consumer/.cargo/bin:$PATH",
            "opt/consumer-uv",
            "opt/consumer-uv/bin/pip",
    ...
    Path("src/tooling/model-cli-harness/suites/copilot-workflow-smoke.json"): frozenset(
        {
            "/" + "tmp/agentic-workspace-fixture-venv",
            "/" + "tmp/uv-cache",
        }
