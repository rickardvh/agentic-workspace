...
INVENTORY_RELATIVE_PATH = Path("src/tooling/contracts/structured_file_inventory.json")
SCHEMA_RELATIVE_PATH = Path("src/tooling/contracts/schemas/structured_file_inventory.schema.json")
...
FULL_INVENTORY_AUTHORITY_PATHS = frozenset(
    {
        "src/tooling/check/check_structured_file_inventory.py",
        "src/tooling/contracts/structured_file_inventory.json",
        "src/tooling/contracts/schemas/structured_file_inventory.schema.json",
    }
)
