...
DEFAULT_EPISODE = harness.REPO_ROOT / "src" / "tooling" / "model-cli-harness" / "episodes" / "intent-proof-packaging-specifier.json"
DEFAULT_OUTPUT_ROOT = harness.DEFAULT_OUTPUT_ROOT / "long-horizon"
AW_MODE_FIXTURE = harness.REPO_ROOT / "src" / "tooling" / "model-cli-harness" / "fixtures" / "aw-minimal-host-repo"
MISTAKE_CLASSES = {
    "wrong_intent",
