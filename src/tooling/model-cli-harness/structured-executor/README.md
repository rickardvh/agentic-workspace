...
```text
python src/tooling/model-cli-harness/structured-executor/structured_executor.py validate --state <state.json>
python src/tooling/model-cli-harness/structured-executor/structured_executor.py replay --initial-state <state.json> --transitions <inputs.json>
```
