...
mod native_independent_publication;
...
#[path = "modules/memory/native_memory_write.rs"]
...
mod native_payload;
#[path = "modules/planning/native_planning.rs"]
mod native_planning;
#[path = "modules/planning/native_planning_create.rs"]
mod native_planning_create;
#[path = "modules/planning/native_planning_retention.rs"]
...
#[path = "modules/verification/native_source_reconciliation.rs"]
mod native_source_reconciliation;
mod native_startup;
#[path = "modules/verification/native_verification.rs"]
...
mod schema_reuse_tests {
    ...
    fn immutable_source_contract_parse_is_shared_and_measured() {
        ...
        let bytes = include_str!("../contracts/schemas/source_decision_input.schema.json");
...
#[path = "modules/verification/proof_publication.rs"]
