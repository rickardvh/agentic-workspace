...
_runtime = load_generated_cli_package_module(
    bundled_module="repo_memory_bootstrap._generated_cli_package_impl.memory_runtime_cli",
    generated_root="generated/python/memory-cli",
    file_name="memory_runtime_cli.py",
    module_name="_repo_memory_bootstrap_generated_runtime_cli",
)
