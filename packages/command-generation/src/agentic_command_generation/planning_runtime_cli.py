...
_runtime = load_generated_cli_package_module(
    bundled_module="repo_planning_bootstrap._generated_cli_package_impl.planning_runtime_cli",
    generated_root="generated/python/planning-cli",
    file_name="planning_runtime_cli.py",
    module_name="_repo_planning_bootstrap_generated_runtime_cli",
)
