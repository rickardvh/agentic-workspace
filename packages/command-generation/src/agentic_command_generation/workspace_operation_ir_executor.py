...
_runtime = load_generated_cli_package_module(
    bundled_module="agentic_workspace._generated_cli_package_impl.workspace_operation_ir_executor",
    generated_root="generated/python/workspace-cli",
    file_name="workspace_operation_ir_executor.py",
    module_name="_agentic_workspace_generated_operation_ir_executor",
)
