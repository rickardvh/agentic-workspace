...
5. Point out the shipped bootstrap-managed memory skills under `.agentic-workspace/memory/skills/` and any repo-specific memory skills under `memory/skills/`, keeping the managed package home concentrated under `.agentic-workspace/` rather than spreading package-managed machinery across the wider repo.
...
- Keep repo-specific memory workflows under `memory/skills/`, not under `.agentic-workspace/memory/bootstrap/skills/`.
