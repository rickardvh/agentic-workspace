...
CORE_PAYLOAD_SKILL_FILES = (
    ...
    SHIPPED_SKILLS_ROOT / "memory-capture/procedure.md",
    SHIPPED_SKILLS_ROOT / "memory-capture/references/candidate.md",
    SHIPPED_SKILLS_ROOT / "memory-capture/references/destination.md",
    SHIPPED_SKILLS_ROOT / "memory-capture/references/publication.md",
    ...
    SHIPPED_SKILLS_ROOT / "memory-hygiene/procedure.md",
    SHIPPED_SKILLS_ROOT / "memory-hygiene/references/declarations.md",
    SHIPPED_SKILLS_ROOT / "memory-hygiene/references/disposition.md",
    SHIPPED_SKILLS_ROOT / "memory-hygiene/references/repair.md",
