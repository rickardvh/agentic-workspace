...
def apply_planning_integration_propose_operation(values: dict, _arguments: dict, _context):
    return _call_planning_operation(
        ...
        keywords=(
            ...
            ("proof", "proof", "str", ""),
            ("what_happened", "what_happened", "str", ""),
            ("scope_touched", "scope_touched", "str", ""),
            ("changed_surfaces", "changed_surfaces", "str", ""),
            ("review_summary", "review_summary", "str", ""),
            ("outcome_summary", "outcome_summary", "str", ""),
            ...
            ("record_feature_completion", "record_feature_completion", "bool", None),
            ("refresh_existing", "refresh_existing", "bool", None),
            ("expected_proposal_revision", "expect_proposal_revision", "str", ""),
            ("target", "target", "raw", None),
            ("expected_planning_revision", "expect_planning_revision", "str", ""),
            ("dry_run", "dry_run", "bool", None),
        ),
...
def apply_planning_archive_plan_operation(values: dict, _arguments: dict, _context):
    ...
    return _call_planning_operation(
        ...
        keywords=(
            ...
            ("compact_retained", "compact_retained", "bool", None),
            ("export_dir", "export_dir", "raw", None),
            ("expected_planning_revision", "expect_planning_revision", "str", ""),
