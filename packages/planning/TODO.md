...
- Keep direct-task rows self-sufficient: if they need milestone sequencing, blocker handling, non-obvious validation, rollback or migration notes, or long narrative text, promote them into `.agentic-workspace/planning/execplans/`.
