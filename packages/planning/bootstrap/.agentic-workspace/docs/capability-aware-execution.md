...
The authoritative machine-readable version of this contract is available at [`.agentic-workspace/docs/capability-contract.json`](capability-contract.json).
...
- active planned work in `.agentic-workspace/planning/execplans/`
...
- promote into `.agentic-workspace/planning/execplans/`
...
- `.agentic-workspace/planning/reviews/` when the right remediation still needs bounded analysis
