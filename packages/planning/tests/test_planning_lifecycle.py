...
def test_planning_clean_install() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert not (target / ".agentic-workspace/planning/TODO.md").exists(), "generated TODO.md should not be created after install"
        assert not (target / ".agentic-workspace/planning/ROADMAP.md").exists(), "generated ROADMAP.md should not be created after install"
...
def test_planning_install_dry_run() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert not (target / ".agentic-workspace/planning/ROADMAP.md").exists(), "generated ROADMAP.md created during dry-run"
