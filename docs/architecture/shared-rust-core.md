...
| #2989 | Known independent actions form a ready set as described below; terminal authority still rejects any remaining action. Selected-outcome required obligations remain unresolved. Existing explicit outcome authority, settled/direct distinction, and fail-closed conflicting actions are retained and tested. |
