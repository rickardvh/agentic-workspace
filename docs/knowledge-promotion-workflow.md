...
Promote knowledge when it satisfies the **Anti-Concealment** and **Repeated-Evidence** rules in [`docs/signal-hygiene-contract.md`](signal-hygiene-contract.md), specifically:
...
| **Enforceable Rules** | Config / Checks | Policy that can be machine-read or verified (e.g. `agentic-workspace.toml`, `scripts/check/`). |
...
- **To Config**: Update `agentic-workspace.toml` or equivalent.
