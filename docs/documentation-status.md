...
| [`docs/package/modules.md`](package/modules.md) | adopters choosing core modules | public module selection explanation | current | current Planning and Memory positioning | Keep aligned with `agentic-workspace defaults --section install_profiles --format json`. |
