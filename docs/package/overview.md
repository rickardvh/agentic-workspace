...
Exact profile and footprint metadata is defined in the generated [Module registry](../reference/module-registry.md). Exact command metadata is defined in [CLI commands](../reference/cli-commands.md). Knowledge routing and source authority are defined in [Knowledge routing and source authority](knowledge-routing.md).
