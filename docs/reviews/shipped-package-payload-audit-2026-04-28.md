...
| Root generated command adapter metadata | generated/proof-only | `generated/python/workspace-cli/generated_command_adapters.json` in source/sdist | Keep out of package-local runtime modules; checks and conformance load generated JSON. |
...
| Planning generated command adapter metadata | generated/proof-only | `generated/python/planning-cli/generated_command_adapters.json` in source tree | Keep out of package-local runtime modules; checks and conformance load generated JSON. |
...
| Memory generated command adapter metadata | generated/proof-only | `generated/python/memory-cli/generated_command_adapters.json` in source tree | Keep out of package-local runtime modules; checks and conformance load generated JSON. |
