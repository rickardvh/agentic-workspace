...
- In this repository, implementation agents do not post reviewer comments or decision markers on PRs they implemented; this is maintainer guidance in repo Memory, not a portable AW review contract or enforcement mechanism.
