...
| Active planning inspection and restart handoff | `agentic-planning-bootstrap summary --target ./repo --format json` | `TODO.md`, `ROADMAP.md`, `docs/execplans/README.md`, `docs/environment-recovery-contract.md` | 1 | 4 | 3 | 18858 | 86.0% |
| Proof-lane selection | `agentic-workspace defaults --section proof_selection --format json` | `docs/default-path-contract.md`, `docs/proof-surfaces-contract.md` | 1 | 2 | 1 | 10090 | 81.9% |
| Ownership lookup | `agentic-workspace ownership --target ./repo --concern active-execution-state --format json` | `AGENTS.md`, `docs/ownership-authority-contract.md`, `.agentic-workspace/OWNERSHIP.toml` | 1 | 3 | 2 | 16311 | 96.2% |
