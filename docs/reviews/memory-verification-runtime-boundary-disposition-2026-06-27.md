...
payloads. It does not move Memory route/search/capture/review/sync judgement or
...
| `uninstall_bootstrap` | mutation scaffolding | None beyond disposition | Memory lifecycle mutation safety/provenance | Uninstall safety and manual-review behaviour stay package-owned |
| `upgrade_bootstrap` | mutation scaffolding | None beyond disposition | Memory lifecycle mutation safety/provenance | Upgrade source, payload, and safety behaviour stay package-owned |
...
| `suggest_memory_note_capture` | durable-knowledge judgement | None | Memory capture-vs-route judgement | Capture advice encodes relevance and durability judgement |
| `review_routes` | durable-knowledge judgement | None | Memory route quality judgement | Route review evaluates route quality and remediation |
| `route_memory` | durable-knowledge judgement | None | Memory route ranking judgement | Routing ranks relevance and read-first advice |
| `search_memory` | durable-knowledge judgement | None | Memory search relevance judgement | Search semantics are durable-knowledge relevance policy |
| `sync_memory` | durable-knowledge judgement | None | Memory sync/remediation judgement | Sync records and remediates Memory state |
...
- residual owner: command-generation owns generic view/payload scaffolding through
  ...
  command-generation#75; Memory and Verification keep semantic judgement explicit
...
- Memory route/search/capture/review/sync behaviour owns durable-knowledge
  relevance, durability, route quality, and capture-vs-route judgement
- Memory lifecycle/create/migrate/cleanup/uninstall/upgrade behaviour owns
