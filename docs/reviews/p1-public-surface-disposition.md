...
| workspace.resources.scratch-prune | DEPRECATED_COMPATIBILITY | Preserve the 1.x public operation and selection argument with bounded selected-file semantics; ordinary cleanup uses authenticated container removal. |
