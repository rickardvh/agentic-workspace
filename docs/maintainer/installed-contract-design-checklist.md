...
Use `.agentic-workspace/docs/compatibility-policy.md` for stable-versus-mutable surface guidance, `docs/maintainer/maintainer-commands.md` for commands, and `docs/maintainer/contributor-playbook.md` for routing; this page is only the review bar for collaboration-sensitive installed surfaces.
