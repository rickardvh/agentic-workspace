...
| Active parent lane owner | `implement` planning safety gate | remains edit-blocking through existing lane-owner requirement packet | Missing or invalid lane owner artefacts still block implementation before active parent-lane slice work proceeds. |
