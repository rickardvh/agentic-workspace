...
Use the documentation and packages for the same AW release. A newer source checkout can describe behaviour that an older installation does not contain.
...
| --- | --- | --- |
| Source tests | The tested behaviour on that source revision | That older published packages contain it |
| Installed-package checks | The named artefacts worked on the tested environments | Support for every OS, runtime or agent host |
