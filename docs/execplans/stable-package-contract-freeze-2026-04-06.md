...
- Audit the current memory and planning installed surfaces to separate true compatibility contract files from lower-stability helpers and generated mirrors.
