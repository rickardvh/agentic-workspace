...
- `docs/execplans/archive/selective-adoption-proof-refresh-2026-04-13.md`
...
- `full` now preserves the same clean split: the remaining doctor follow-up is expected starter customization (`TODO.md` and `ROADMAP.md` placeholders, plus the existing advisory pressure on `memory/index.md`) rather than lifecycle inconsistency.
