...
- TODO.md
- docs/execplans/planning-hierarchy-routing-tranche-2026-04-17.md
...
- packages/planning/bootstrap/docs/upstream-task-intake.md
...
- The hierarchy stays explicit across direction (`ROADMAP.md`), activation (`TODO.md`), execution (`docs/execplans/`), and bounded review (`docs/reviews/`).
