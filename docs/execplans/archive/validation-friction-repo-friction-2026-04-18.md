...
- TODO.md
- ROADMAP.md
- docs/execplans/validation-friction-repo-friction-2026-04-18.md
...
- Follow-on routed to: `docs/reviews/validation-friction-signal-review-2026-04-18.md` and `ROADMAP.md` next lane `memory-trust-habitual-pull`.
