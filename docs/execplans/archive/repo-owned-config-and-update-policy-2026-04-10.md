...
- Outcome delivered: shipped repo-root `agentic-workspace.toml`, `agentic-workspace config`, config-driven default preset selection, wrapper-owned module update-source sync/reporting, canonical docs, and repo dogfooding of the new contract.
