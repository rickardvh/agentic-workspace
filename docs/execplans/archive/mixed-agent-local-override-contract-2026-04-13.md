...
- `ROADMAP.md`
- `.gitignore`
- `docs/execplans/mixed-agent-local-override-contract-2026-04-13.md`
- `README.md`
...
- Canonical local path: repo-root `agentic-workspace.local.toml`.
...
- `agentic-workspace.local.toml` is a supported optional local-only surface and is gitignored in this repo.
...
- Outcome delivered: shipped a narrow supported `agentic-workspace.local.toml` contract, added source-attributed mixed-agent posture reporting to `agentic-workspace config`, and aligned the config docs and repo gitignore with the new local-only surface.
