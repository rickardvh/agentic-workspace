...
- `TODO.md`
- `docs/execplans/memory-trust-habitual-pull-2026-04-18.md`
- `ROADMAP.md`
- `packages/memory/**`
- `docs/**`
- `tests/**`
...
- Outcome delivered: added `habitual_pull` to `agentic-memory-bootstrap report --format json`, documented the cheap ordinary-work first-pull rule in Memory-owned surfaces, and recorded the recent-case audit in `docs/reviews/memory-habitual-pull-audit-2026-04-18.md`.
