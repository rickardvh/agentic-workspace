...
- Update `docs/capability-aware-execution.md` and the shipped planning surfaces to encode silent shaping, non-interference, and complexity-reduction routing.
...
- `packages/planning/bootstrap/docs/capability-aware-execution.md`
