...
- Status: completed
- Scope: added a local-only target profile table to `agentic-workspace.local.toml`, exposed it through `agentic-workspace config`, aligned formal schemas/docs/tests, and dogfooded it on one realistic local profile.
- Ready: done
- Blocked: none
- optional_deps: none
...
- TODO.md
- docs/execplans/local-delegation-target-profiles-2026-04-17.md
- docs/execplans/archive/local-delegation-target-profiles-2026-04-17.md
- docs/reviews/local-delegation-target-profiles-dogfood-2026-04-17.md
...
- Target profiles belong in `agentic-workspace.local.toml`, not `agentic-workspace.toml`.
...
- `agentic-workspace.local.toml` supports a narrow local-only target profile shape.
