...
Family-level ownership inventory for root workspace_runtime_primitives.py behaviour and high-confidence declarative migrations.

- Source schema: `src/tooling/contracts/schemas/workspace_runtime_primitive_families.schema.json`
...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Family-level ownership inventory for root workspace_runtime_primitives.py behaviour and high-confidence declarative migrations. |  | x-agentic-workspace-doc-role: "contract-reference" |
...
| `shared_core_boundary.enforcement` | string | yes |  | Checker behaviour that keeps the core boundary fail-closed. |  |  |
