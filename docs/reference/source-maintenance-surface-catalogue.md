...
- Contract digest: `sha256:f176d20e093470616ea21f7d6de0f4419c98b63b57f9d65c27ae3f99bf9c75ae`
...
| `.agentic-workspace/planning/execplans/*.plan.json` | `installed-local` | necessary-surfaces, full-mirror | planning | required in the selected footprint |
| `.agentic-workspace/verification/proof-strategy.toml` | `optional` | necessary-surfaces, full-mirror | verification | selected-but-unconfigured: Use generic proof selection until the repo declares a Verification proof strategy. |
