...
Package-owned skill behavior projected from one compiled operating decision; specialized procedures remain behind routed skill owners.
...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Package-owned skill behavior projected from one compiled operating decision; specialized procedures remain behind routed skill owners. |  | x-agentic-workspace-doc-role: "contract-reference"<br>x-agentic-workspace-see-also: ["docs/reference/startup-context.md", "docs/reference/cli-commands.md", "docs/reference/proof-selection-rules.md"] |
