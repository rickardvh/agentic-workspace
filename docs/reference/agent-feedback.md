...
# Agent Feedback Artefact

Optional review artefact shape for comparing agent-feedback evaluations; not a required operating surface unless a later command emits it valid-by-construction.

- Source schema: `src/tooling/contracts/schemas/agent_feedback.schema.json`
...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Optional review artefact shape for comparing agent-feedback evaluations; not a required operating surface unless a later command emits it valid-by-construction. |  | x-agentic-workspace-doc-role: "contract-reference" |
...
| `evaluated_at` | string | yes |  | Timestamp or date when this artefact was evaluated. |  |  |
...
| `findings` | array of object | yes |  | Findings captured by this artefact. |  |  |
