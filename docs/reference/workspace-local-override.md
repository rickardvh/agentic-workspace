...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Current human configuration authoring, version 2. Version 1 sources are read separately; never use former syntax for new settings. |  | x-agentic-workspace-doc-role: "public-reference"<br>x-agentic-workspace-unknown-properties: "reject" |
