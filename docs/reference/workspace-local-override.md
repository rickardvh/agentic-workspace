...
| `delegation_targets.<^.+$>.current_economic_evidence` | object | no |  | Bounded provider-neutral evidence about this target's current marginal opportunity cost. Hard capability, proof, trust, and expected repair burden continue to outrank it. |  |  |
