...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Retained parser fixtures only. These declarations neither install commands nor provide fallback execution. The native_cli declaration in source_decision_contract.json is the public boundary. |  | x-agentic-workspace-doc-role: "contract-reference" |
