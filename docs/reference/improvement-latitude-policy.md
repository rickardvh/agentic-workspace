...
- Source schema: `src/tooling/contracts/schemas/improvement_latitude_policy.schema.json`
...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Source-maintenance model only; not native/public command authority. Policy describing how much improvement initiative agents may take by latitude setting. |  | x-agentic-workspace-doc-role: "contract-reference" |
