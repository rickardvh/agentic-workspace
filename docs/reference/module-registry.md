...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Source-maintenance distribution and domain inventory only. Native module authority is the Rust independent_owner API and capability-contract/v1. No procedural participation or phase registration model. |  | x-agentic-workspace-doc-role: "contract-reference" |
