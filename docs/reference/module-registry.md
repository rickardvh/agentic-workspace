...
Source-maintenance model only; not native/public command authority. Registry of Agentic Workspace core modules and current orchestration metadata.
...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Source-maintenance model only; not native/public command authority. Registry of Agentic Workspace core modules and current orchestration metadata. |  | x-agentic-workspace-doc-role: "contract-reference" |
...
| `terminology` | object | no |  | Current module terminology and future extension boundary. |  |  |
