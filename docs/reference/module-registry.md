...
Registry of Agentic Workspace core modules and current orchestration metadata.
...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Registry of Agentic Workspace core modules and current orchestration metadata. |  | x-agentic-workspace-doc-role: "contract-reference" |
