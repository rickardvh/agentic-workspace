...
# Former source recognition: Agentic Workspace Repo Config
...
- Source schema: `src/agentic_workspace/contracts/schemas/workspace_config_former.schema.json`
...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Bounded version-1 source recognition only. Not a current authoring or permission contract. Preserve unresolved source meaning; exact current edits cannot create deprecated values. |  | x-agentic-workspace-doc-role: "public-reference"<br>x-agentic-workspace-see-also: [".agentic-workspace/docs/workspace-config-contract.md", "docs/reference", "docs/generated"]<br>x-agentic-workspace-unknown-properties: "warn" |
...
| `assurance.requirements.<name>.applies_to_task_markers` | array of string | no | `[]` | Recognized former semantic scope. Markers never match raw task text as authority; exact facts or current agent applicability judgment resolve this scope. |  |  |
