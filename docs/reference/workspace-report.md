...
| `closeout_report.completion_gate.required_next_action` | enum `"continue-current-work"`, `"create-follow-on-plan"`, `"activate-next-slice"`, `"ask-human"`, `"close-complete"`, `"close-human-accepted-partial"` or closeout-trust report command | yes |  | Required transition before the workflow can stop or claim completion. |  |  |
...
| `closeout_report.completion_gate.claim_authorization.blocked_claim_classes` | array of enum `"partial_progress"`, `"local_pr_complete"`, `"slice_complete"`, `"leaf_issue_complete"`, `"lane_complete"`, `"parent_issue_complete"`, `"parent_complete"`, `"full_intent_complete"`, `"issue_closure"` | yes |  | Claim classes renderers must not use. |  |  |
