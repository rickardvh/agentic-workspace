...
- Source schema: `src/tooling/contracts/schemas/improvement_signal_contract.schema.json`
...
| --- | --- | --- | --- | --- | --- | --- |
| (root) | object | yes |  | Source-maintenance model only; not native/public command authority. Contract for classifying improvement signals and routing them to the right owner surface. |  | x-agentic-workspace-doc-role: "contract-reference" |
